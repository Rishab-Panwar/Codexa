...
export default function ContextPanel() {
    ...
    useEffect(() => {
        ...
        window.addEventListener("codexa:query", handler);
        return () => window.removeEventListener("codexa:query", handler);
    }, []);
    ...
    useEffect(() => {
        ...
        window.addEventListener("codexa:repo-switched", handler);
        return () => window.removeEventListener("codexa:repo-switched", handler);
    }, [loadOverview]);
