...
export default function ChatWindow() {
    ...
    useEffect(() => {
        ...
        window.addEventListener("codexa:prefill-question", handler);
        return () => window.removeEventListener("codexa:prefill-question", handler);
    }, []);
    ...
    const handleSend = useCallback(async () => {
        ...
        try {
            ...
            window.dispatchEvent(
                new CustomEvent("codexa:query", { detail: { question: userMsg } }),
            );
